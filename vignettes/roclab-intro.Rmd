...
The **roclab** package implements ROC optimizing binary classification, supporting
...
accuracy, making ROC optimizing binary classification practical for large-scale
datasets.
...
The **roclab** package implements ROC optimizing binary classification through
